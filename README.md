...
analysis. It makes it lauching the application via a function exported
by the own package.
...
also refactor some parts of the application logic into R functions
...
For more details and information about the content and how the
dashoboard application works go to the pkgdown website:
[shinyCovidWorld](https://etc5523-2020.github.io/r-package-assessment-prigrecov/).

## Installation of `shinyCovidWorld` package
...
This is a basic example of how to run this package:
